    ...
    <template v-else>
      ...
      <section class="detail-main">
        ...
        <div class="detail-main__left">
          ...
          <div class="detail-main__img-col">
            <div class="detail-thumb-list">
              <button
                ...
                @click="activeThumb = i"
              >
                <img :src="img" :alt="`thumbnail ${i + 1}`" class="detail-thumb-img" />
              </button>
            </div>
          ...
          <!-- 설명 영역 (이미지 아래) -->
          <div class="detail-main__desc-section">
            <p class="detail-main__desc">{{ product.description }}</p>
            ...
            <div class="detail-accordion">
              ...
              <details class="detail-accordion__item">
                ...
                <div class="detail-accordion__body">
                  <p v-for="line in product.composition" :key="line">{{ line }}</p>
                </div>
              </details>
        ...
        <div class="detail-main__info-col">
          <div class="detail-main__info">
            ...
            <span class="detail-main__style-no">Style No. {{ String(product.id).padStart(6, '0') }}</span>
            ...
            <div class="detail-option">
              ...
              <div class="detail-color-dot" :style="{ backgroundColor: product.colorHex }"></div>
            </div>
...
const thumbnails = computed(() => {
  // images 배열 있으면 사용, 없으면 대표 이미지 1장
